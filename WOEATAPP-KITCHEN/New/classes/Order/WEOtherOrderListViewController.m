//
//  WEOtherOrderListViewController.m
//  WOEATAPP-KITCHEN
//
...
@interface WEOtherOrderListViewController ()
{
    UIView *_topView;
    ...
    WEOrderFilterViewOther *_filterView;
...
@implementation WEOtherOrderListViewController
...
- (void)viewDidLoad {
    ...
    _filterView = [WEOrderFilterViewOther new];
    ...
    _filterView.check1 = 0;
    _filterView.check2 = 0;
...
- (void)loadData
{
    NSArray *statusArray = @[@"",
                             ...
                             WEOrderStatus_REJECTED,
                             WEOrderStatus_READY,
                             WEOrderStatus_DISPATCHED,
                             WEOrderStatus_RECEIVED];
    ...
    [WENetUtil GetOrderListOtherDaysWithOrderStatus:status
...
- (void)headerTapped:(UIButton *)button
{
    if (_filterView.hidden) {
        ...
        _tip1.text = @"点击取消过滤条件";
        //NSLog(@"_filterView.getHeight=%f", _filterView.getHeight);
